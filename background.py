...
output_files = cv2.VideoWriter('output.avi',fourcc,20.0,(640,480)) 
image = Image.open('Bangok.jpg')
cap = cv2.VideoCapture(0)
time.sleep(2)

# declaring background variable
bg = 0 
# running for loop for first 60 frames
# whatever is captured in the first 60 frames is called as bg
# flipped image is captured so again flipping it
for i in range(60):
    ret, bg = cap.read()
...
while(cap.isOpened()):
    ...
    # Detect the red color and make it transparent
